...
public class GetAttributesFeature implements Feature {
    private final BeanMetadata beanMetadata;

    public GetAttributesFeature(BeanMetadata beanMetadata) {
    ...
    private MethodSpec overrideAttributes(BeanMetadata beanMetadata) {
        ...
        return MethodSpec.methodBuilder("getAttributes")
                ...
                .addStatement("$T.<$T>asList($L).stream().forEach(dao -> result.addAll(dao.getAttributes()))", CommonTypes.ARRAYS, CommonTypes.DAO, properties.stream()
