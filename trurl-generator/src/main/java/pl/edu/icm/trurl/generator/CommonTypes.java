...
public class CommonTypes {
    ...
    public static final ParameterizedTypeName ENTITY_LIST = ParameterizedTypeName.get(ClassName.get(List.class), ClassName.get(DetachedEntity.class));
    ...
    public static final ClassName ENTITY = ClassName.get(DetachedEntity.class);
