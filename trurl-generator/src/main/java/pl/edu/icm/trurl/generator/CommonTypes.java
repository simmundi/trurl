...
public class CommonTypes {
    ...
    public static final ClassName ENUM_COLUMN = ClassName.get(CategoricalStaticAttribute.class);
    ...
    public static final ClassName SOFT_ENUM_COLUMN = ClassName.get(CategoricalDynamicAttribute.class);
