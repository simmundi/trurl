...
/**
 * Predicate to decide whether an entity should be created based on its prototype.
 */
public interface EntityCreatorPredicate extends Predicate<EntityPrototype> {
}
