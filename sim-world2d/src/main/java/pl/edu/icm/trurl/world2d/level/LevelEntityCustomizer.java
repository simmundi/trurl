...
/**
 * Hook to customize a newly created entity based on its prototype.
 */
public interface LevelEntityCustomizer {
    void customize(Entity entity, EntityPrototype prototype);
}
