...
public final class DaoManager {
    ...
    public DaoManager(ComponentAccessor componentAccessor, Map<Class<?>, BentoFactory<?>> factories, DaosCreator daosCreator) {
        ...
        for (int idx = 0; idx < componentCount(); idx++) {
            ...
            this.daos[idx] = daosCreator.createDao(factory);
