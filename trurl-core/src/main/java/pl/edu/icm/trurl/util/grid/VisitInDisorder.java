 ...
 *
 * The git repo: https://github.com/lemire/Code-used-on-Daniel-Lemire-s-blog
 *
 * Quote from the author: "Unless otherwise stated, I make no copyright claim on this code: you may consider it to be in the public domain."
 *
 */
