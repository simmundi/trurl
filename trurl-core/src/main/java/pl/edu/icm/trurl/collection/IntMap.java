/*
 * Copyright (c) 2023 - see the NOTICE file.
 *
...
import static pl.edu.icm.trurl.collection.ObjectSet.tableSize;
...
public class IntMap<V> {
	...
	public boolean equalsIdentity (Object obj) {
		...
		for (int i = 0, n = keyTable.length; i < n; i++) {
			int key = keyTable[i];
			if (key != 0 && valueTable[i] != other.get(key, dummy)) return false;
		}
		return true;
	}
