 ...
 public class IteratingSystemBuilder {
     ...
     public IteratingSystemBuilder(Supplier<Index> indexSupplier) {
         this.indexSupplier = indexSupplier;
     }

     public IteratingSystemBuilder(Index index) {
         this.indexSupplier = () -> index;
     }

     public Config iteratingOver() {
         return new IteratingSystem(indexSupplier, false);
     }

     public Config iteratingOverInParallel() {
         return new IteratingSystem(indexSupplier, true);
     }
