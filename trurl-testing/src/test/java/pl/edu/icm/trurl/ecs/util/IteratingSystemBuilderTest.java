...
//        when(sessionFactory.createOrGet(anyInt())).thenReturn(session);
//
//        // execute
...
//        verify(action1, times(1000)).perform(anyString(), eq(session), anyInt());
//        verify(action2, times(1000)).perform(anyString(), eq(session), anyInt());
//    }
//
//    @Test
...
//
//        // execute
//        EntitySystem system = IteratingSystemBuilder.iteratingOver(rangeIndex)
//                .withoutPersisting()
//                .withContext(contextFactory)
//                .perform(action1)
//                .build();
