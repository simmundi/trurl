...
public class DaoIT {
    ...
    @Spy
    DaoManager daoManager = new DaoManager(new DynamicComponentAccessor(Collections.emptyList()), factories, daosCreator);
    @Mock
    Session session;
    ...
    void before() {
        ...
        dao = new DaosCreator().createDao(BunchOfData.class);
